    ...
    <main className="relative min-h-screen overflow-hidden px-6 py-10 md:px-10">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl items-center justify-center">
        <div className="grid w-full gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <aside className="construction-card fade-up delay-2" aria-label="Animação de construção do site">
            <div className="video-shell w-full">
              <video
                ...
                aria-label="Ambiente visual de construção"
              />
              <div className="video-vignette" aria-hidden="true" />
              <span className="video-chip">Em produção</span>
            </div>

            <p className="mt-5 text-sm font-semibold tracking-[0.16em] text-[#1D3557] uppercase">A construir algo grande</p>
            <p className="mt-2 text-sm text-[#475569]">Building something remarkable</p>
          </aside>
        </div>
      </section>
    </main>
